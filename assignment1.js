...
let fruits=[];
console.log("Before  adding fruits to array"+fruits);

//2. Add the following fruits to the "fruits" array: "apple", "banana", "orange".
fruits.push("apple", "banana", "orange");
console.log("after adding fruits to array >>"+fruits);

//3. Remove the first fruit from the array.
fruits.splice(0,1);
console.log("after removing first  fruits to array >> "+fruits);
// 4. Add "grape" to the end of the array.
fruits.push("grapes");
console.log("after adding grapes to array >> "+fruits);

// 5. Update the second fruit in the array to "pear".
fruits.splice(1,1,"pear")
console.log("after updating banana to pear to array >> "+fruits);

// 6. Print the final "fruits" array after performing the above operations.
console.log("after final update >> "+fruits);